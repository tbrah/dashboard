...
export class TaskService {
  ...
  tasks=[
    ...
    {id:2, status:"done", title:"Testing 32", description:"testing description 3", startdate:"02-03-2017", deadline:"24-03-2017", budget:"550", print:true, location:"MainStorage/here/there/here/file.psd", papprove:false, adminapprove:true, participent:"Kristy Cunt", participentpic:"kristy.png", orderby:"Whitney Jørgensen", orderbypic:"whitney.jpg"},
  ]
